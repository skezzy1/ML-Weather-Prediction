...
df = pd.read_csv("data_preparation/csv/data.csv")
...
plt.title(f'Кореляційна матриця погодних параметрів')
plt.show()

print(correlation_matrix)
#city_data.to_csv('data_preparation/csv/cities/lviv_data.csv', index=False, encoding='utf-8')
correltion_result = f"data_preparation/Correlation/correlation_result.txt"
